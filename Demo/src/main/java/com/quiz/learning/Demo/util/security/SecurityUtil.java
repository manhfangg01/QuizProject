...
public class SecurityUtil {
    ...
    public SecurityUtil(JwtEncoder jwtEncoder, UserRepository userRepository, AdminRoleService adminRoleService) {
    ...
    @Value("${AccessToken-Validity-In-Seconds}")
    ...
    public static Optional<String> getCurrentUserLogin() {
        ...
        if (authentication != null &&
            ...
            return Optional.of(authentication.getName()); // Thường là email hoặc username
        }
